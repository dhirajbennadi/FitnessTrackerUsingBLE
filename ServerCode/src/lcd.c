...
#define TIMER_TICKS_1SEC     32768
#define TIMER_HANDLE          0
...
void displayInit()
{
    ...
    sl_status_t timer_response;
	  timer_response = sl_bt_system_set_soft_timer(TIMER_TICKS_1SEC, TIMER_HANDLE, TIMER_REPEAT_MODE);
	  if (timer_response != SL_STATUS_OK) {
	      //LOG_...
	      LOG_ERROR("Soft Timer Failed code = %d\n\r", timer_response);
     }
